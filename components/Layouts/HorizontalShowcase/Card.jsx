...
export default function Card({ item, variant = "landscape" }) {
   ...
   function styleParent() {
      if (variant === "landscape") return "w-36 h-40 md:w-80 md:h-60";
      return "w-36 h-48 md:w-64 md:h-80";
   }

   return (
      <div 
         className={`${styleParent()}   active-shrink relative m-2 inline-block bg-pink-100`}
      >
         <img className="w-full h-full object-cover bg-center" src={img}/>
         {/* <img className="w-full h-full object-cover" src="https://static-01.daraz.pk/p/b35a50a5cbdb0fcc8ee5564dec5d5ffb.jpg"/> */}
